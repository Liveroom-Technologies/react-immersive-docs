...
Controls animation playback for supported GLB/GLTF, FBX, and USDZ models that
contain embedded animations.
...
|------|------|-------------|
| `clips` | `string[]` | Animation clip names found in the model file |
