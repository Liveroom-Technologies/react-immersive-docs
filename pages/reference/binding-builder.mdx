...
A locked feature is shown in place (not hidden) with a message naming the required plan, so the feature stays discoverable while editing. Get a license key at the [Liveroom Developer Portal](https://react-immersive.liveroom.dev).
